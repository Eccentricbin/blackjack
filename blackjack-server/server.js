...
const gameSchema = new mongoose.Schema({
    ...
    player: playerSchema,
    dealer : playerSchema,
    winning: String, //New field to store the winner
});
...
app.post('/game/hit', async (req, res) => {
    try {
        ...
        game.player.hand.push(drawCard);
...
app.post('/game/stand', async (req, res) => {
    try {
        ...
        //Save the updated game to the databse
        await game.save();
...
//Helper funstion to calculate the score of a hand
